...
const EachBrandDetails = () => {
    ...
    const { _id, select, brand, name, image, price, description, rating, full_details } = eachBrandDetails;
    ...
    return (
        <div>
            <div className="space-y-5">
                ...
                <button className="btn btn-block bg-red-500 mb-5">Add To Cart</button>
            </div>
        </div>
    );
};
